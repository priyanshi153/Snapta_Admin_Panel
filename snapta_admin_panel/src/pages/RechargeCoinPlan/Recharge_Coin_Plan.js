...
const [isChecked, setIsChecked] = useState(false)
  ...
  return (
    <div className="mb-10 pl-72">
      ...
      <div className="flex justify-between border-t-[#F2F2F2] py-3 px-6">
        <h2 className="text-[#000000] font-poppins text-xl font-semibold pt-3">Recharge Coin List</h2>
      ...
      <div className="flex items-center justify-between px-6">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-[#858585] font-poppins text-base">Recharge Coin List</h3>
        </div>
  ...
  <div className="bg-[#452B7A] flex py-4 px-4 border-b text-left pl-16">
    ...
    <div className="w-[65%] text-[#FFFFFF] font-poppins text-sm flex place-items-center gap-2">COIN <button><img src={Dropdown} className="w-3 h-3"/></button></div>
    <div className="w-[65%] text-[#FFFFFF] font-poppins text-sm flex place-items-center gap-2">AMOUNT TO PAY <button><img src={Dropdown} className="w-3 h-3"/></button></div>
    <div className="w-[65%] text-[#FFFFFF] font-poppins text-sm">STATUS</div>
  ...
  {HashtagList?.map((post, index) => (
    <div key={post.id} className="flex items-center px-4 py-3 pl-16 bg-white border-b last:border-0">
      {/* Serial Number */}
      <div className="w-[50%] text-[#000000] font-poppins text-sm">{index + 1}</div>

      {/* coin */}
      <div className="w-[65%]">
        <h2 className='font-poppins text-[#333333] text-sm'>{post.coin}</h2>
      </div>

      {/* amount */}
      <div className="w-[65%] flex gap-2 items-center">
        <p className='text-[#333333] font-poppins text-base'>{post.amount}</p>
      </div>

      {/* Status toggle button */}
      <div className="w-[65%] text-[#3A3A3A] font-poppins text-sm">
      <label className='flex items-center cursor-pointer select-none'>
        <div className='relative'>
          <input
            ...
            className='sr-only'
          />
          <div className='block h-6 w-10 rounded-full border border-[#452B7A] xl:border-[#452B7A] lg:text-base 2xl:border-[#452B7A]'></div>
          <div className='dot absolute left-1 top-1 h-4 w-4 rounded-full bg-[#452B7A] transition'></div>
        </div>
      </label>
      </div>
...
export default RechargeCoinPlanList;
