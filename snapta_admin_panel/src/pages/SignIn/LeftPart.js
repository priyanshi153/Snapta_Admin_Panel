...
import TopRight from '../../assets/SignInRight.png'
...
function LeftImage() {
  return (
    <div
      className="relative top-0 left-0 flex items-center justify-center hidden w-full h-screen text-white lg:h-full lg:block bg-button-gradient"
    ...
    >
      ...
      <p className="absolute text-[#FFFFFF] text-opacity-[41%] bottom-10 2xl:px-96 lg:px-48">All rights reserved</p>
    </div>
  );
}
